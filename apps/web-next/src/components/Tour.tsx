...
export const DEFAULT_DASHBOARD_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    content: 'Access all features from here. Click any item to navigate, or use keyboard shortcuts (Alt+1-9).',
    placement: 'right',
  },
  {
    id: 'chat',
  ...
  },
  {
    ...
    title: 'Agent Builder',
    content: 'Create and configure your AI agents. Each agent can have different personalities, knowledge, and capabilities.',
    placement: 'right',
  },
  {
    id: 'soul-editor',
    target: '[data-tour="nav-soul-editor"]',
    title: 'Soul Editor',
    content: 'Define your agent\'s personality, values, and behavioral guidelines. This is what makes each agent unique.',
    placement: 'right',
  },
  {
    id: 'skills',
    ...
    content: 'Extend your agents with skills like file management, GitHub integration, web search, and more.',
    placement: 'right',
  },
  {
    id: 'schedules',
    target: '[data-tour="nav-cron"]',
  ...
  },
  {
    ...
    content: 'Fine-tune your gateway, manage API keys, providers, and customize your experience.',
    placement: 'right',
  },
  {
    id: 'main-content',
    ...
    content: 'This is where you\'ll see the content for each section. The interface updates based on what you select in the sidebar.',
    placement: 'top',
  },
];
