...
export default function A11yAuditDashboard({ isLoading = false }: { isLoading?: boolean }) {
  ...
  return (
    <>
      <a
        href="#aad-main"
        className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:top-2 focus:left-2 focus:px-4 focus:py-2 focus:bg-indigo-600 focus:text-fg-primary focus:rounded-lg focus:outline-none"
      >
