...
import { MessageSquare, Edit3, Circle, User, Settings, ExternalLink } from 'lucide-react';
    ...
    <div className="flex gap-6 h-full p-6 bg-gray-950 min-h-screen">
      ...
      <div className="flex-1 grid grid-cols-1 xl:grid-cols-2 gap-6 overflow-y-auto pr-2 custom-scrollbar">
        {MOCK_AGENTS.map((agent) => (
          ...
          >
            {/* Gradient Glow */}
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-violet-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="space-y-2 mb-4">
                  {[
                    { label: 'Formality', value: agent.personality.formality },
                    { label: 'Humor', value: agent.personality.humor },
                    { label: 'Verbosity', value: agent.personality.verbosity },
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {agent.skills.slice(0, 3).map((skill) => (
                    <span key={skill} className="px-2 py-0.5 rounded-md bg-blue-900/20 border border-blue-500/20 text-blue-400 text-[10px]">
                      {skill}
                    </span>
                  ))}
                </div>
