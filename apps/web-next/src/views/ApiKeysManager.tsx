...
function webhookStatusBadge(status: Webhook["status"]): string {
  return {
    active: "bg-emerald-500/15 text-emerald-400 border border-emerald-500/30",
    paused: "bg-zinc-500/15 text-fg-secondary border border-zinc-500/30",
...
function CreateKeyModal({ onClose, onCreated }: CreateKeyModalProps) {
  ...
  return (
    ...
    >
      <div className="w-full max-w-lg bg-surface-1 border border-white/10 rounded-xl shadow-2xl">
        {/* Header */}
          ...
          <div className="p-6 space-y-5">
                ...
                {(["30", "90", "365", "never"] as const).map(v => (
                  <button
                    ...
                    className={cn(
                      ...
                      expiry === v
                        ? "bg-violet-600 border-violet-500 text-fg-primary"
            ...
            <div className="flex justify-end gap-3 pt-1">
              ...
              <button
                ...
                className="px-4 py-2 text-sm rounded-lg bg-violet-600 hover:bg-violet-500 text-fg-primary font-medium transition-all disabled:opacity-40 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500"
              >
                Generate Key
              </button>
            </div>
          ...
          <div className="p-6 space-y-5">
            ...
            <div className="flex justify-end">
              <button
                type="button"
                onClick={onClose}
                className="px-4 py-2 text-sm rounded-lg bg-violet-600 hover:bg-violet-500 text-fg-primary font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500"
              >
                Done
              </button>
            </div>
    ...
    <div className="flex gap-4 h-[calc(100vh-240px)] min-h-0">
      ...
      <div className="w-80 shrink-0 flex flex-col gap-3">
        ...
        <button type="button" onClick={onCreate}
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-violet-600 hover:bg-violet-500 text-fg-primary text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500">
        ...
        {tabs.map(tab => (
          <button
            ...
            className={cn(
              ...
              activeTab === tab.id
                ? "bg-violet-600 text-fg-primary shadow"
          ...
          >
            ...
            <span className={cn(
              ...
              activeTab === tab.id ? "bg-white/20 text-fg-primary" : "bg-white/10 text-muted-foreground"
            )}>
              {tab.count}
            </span>
          </button>
