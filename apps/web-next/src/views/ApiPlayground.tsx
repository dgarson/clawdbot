            ...
            <div>
              ...
              <div className="mt-2 flex items-center bg-surface-2 border border-tok-border rounded-md overflow-hidden">
                ...
                <input
                  ...
                  aria-label="API path"
                  className="flex-1 bg-transparent px-3 py-2 text-sm text-fg-primary placeholder:text-fg-muted
                ...
                {headers.map((header) => (
                  <div key={header.id} className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-surface-2 border border-tok-border rounded px-2 py-1.5 text-sm text-fg-primary placeholder:text-fg-muted
                        focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
                    />
                    <input
                      type="text"
