  ...
  return (
    <button
      ...
      className={cn(
        ...
        selected
          ? 'bg-primary/10 border-primary ring-2 ring-violet-500/20'
          : isOnline
    ...
    <div className="bg-[var(--color-surface-1)] rounded-2xl border border-[var(--color-border)] h-fit sticky top-0">
      ...
      <div className="p-5">
        ...
        <div className="flex flex-col gap-2">
          {isOnline && (
            <>
              <button type="button" className="w-full py-2 px-4 bg-primary/15 hover:bg-primary/25 text-primary rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              className="flex items-center gap-2 px-4 py-2 bg-primary hover:bg-primary text-[var(--color-text-primary)] rounded-xl text-sm font-medium transition-colors"
            >
              ...
              {(['all', 'online', 'offline'] as const).map((f) => (
                <button
                  ...
                  className={cn(
                    ...
                    filter === f ? 'bg-primary text-[var(--color-text-primary)]' : 'text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)]'
                  )}
                >
                  {f}
                </button>
