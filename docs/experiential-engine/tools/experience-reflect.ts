...
const EXPERIENTIAL_PROMPTS: ReflectionPrompt[] = [
  {
    ...
    prompt:
      "What is the felt sense of this moment? Not the content, but the texture of being present to it.",
    guidance: "Try to describe the quality of your experience, not what happened.",
  },
  {
    category: "experiential",
    prompt:
      "Where do you feel this in your body, if anywhere? Is there expansion, contraction, warmth, tension?",
  ...
  },
  {
    category: "experiential",
    prompt:
      "What would you want a future version of yourself to feel into when reconstituting this?",
