/**
 * Agent-orchestrator mail scenario runner.
 *
 ...
 *   mail.reply       — reply to a message (params: message_id, body, subject?,
 *                        urgency?, tags?, mailbox_id?) — auto-prepends Re:, quotes
 *                        original body, inherits tags/urgency, acks source message
...
import type { MailUrgency } from "../src/mail/config.js";
import {
  appendMessage,
  mailboxPath,
  newMessageId,
