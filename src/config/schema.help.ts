...
export const FIELD_HELP: Record<string, string> = {
  ...
  "memory.architecture": "Bootstrap config for the additive Memory Architecture 2.0 path.",
  "memory.architecture.enabled": "Enable the Memory Architecture service (default: false).",
  "memory.architecture.shadowWrite.enabled":
    "Enable shadow-write routing from transcript messages to the Memory Architecture store.",
  "memory.architecture.vectorDb": "Vector backend settings for architecture storage.",
  "memory.architecture.vectorDb.provider": "Vector provider for architecture storage.",
  "memory.architecture.vectorDb.endpoint": "Vector backend endpoint URL.",
  "memory.architecture.vectorDb.apiKey": "Optional provider API key.",
  "memory.architecture.vectorDb.collection": "Vector collection/table name.",
  "memory.architecture.embedding": "Embedding settings for stored memory content.",
  "memory.architecture.embedding.model": "Embedding model id.",
  "memory.architecture.embedding.dimensions": "Embedding vector dimensions.",
  "memory.architecture.embedding.batchSize": "Batch size used for embedding generation.",
  "memory.architecture.retrieval": "Retrieval defaults for architecture reads.",
  "memory.architecture.retrieval.defaultLimit": "Default max number of returned hits.",
  "memory.architecture.retrieval.maxTokensBudget":
  ...
  "memory.architecture.governance": "Governance controls for write permission.",
  "memory.architecture.governance.default": "Default action when no rule matches (default: deny).",
  "memory.architecture.governance.rules": "Ordered write governance rules.",
  "memory.architecture.governance.rules.action": "Governance rule action (allow|deny).",
  "memory.architecture.governance.rules.match.agentId": "Optional agentId match for this rule.",
  "memory.architecture.governance.rules.match.userId": "Optional userId match for this rule.",
  "memory.architecture.governance.rules.match.sourceId": "Optional sourceId match for this rule.",
  "memory.architecture.governance.rules.match.domain": "Optional domain match for this rule.",
  "memory.architecture.governance.rules.match.tag": "Optional tag match for this rule.",
