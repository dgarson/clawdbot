...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.modelRouting": "Model Routing",
  "agents.defaults.modelRouting.enabled": "Enable model routing",
  "agents.defaults.modelRouting.fallbackModel": "Fallback Route Model",
  "agents.defaults.modelRouting.fallbackThinkLevel": "Fallback Route Thinking Level",
  "agents.defaults.modelRouting.rules": "Model Routing Rules",
  "agents.defaults.modelRouting.rules[].id": "Routing Rule ID",
  "agents.defaults.modelRouting.rules[].intent": "Routing Intent",
  "agents.defaults.modelRouting.rules[].model": "Routing Model",
  "agents.defaults.modelRouting.rules[].thinkLevel": "Routing Think Level",
