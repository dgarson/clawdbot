...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "diagnostics.metrics.enabled": "Prometheus Metrics Enabled",
  "diagnostics.metrics.port": "Prometheus Metrics Port",
  "diagnostics.metrics.endpoint": "Prometheus Metrics Endpoint",
