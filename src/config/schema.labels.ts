...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.exec.ghGuard.enabled": "Exec GitHub Guard Enabled",
  "tools.exec.ghGuard.protectedBranches": "Exec GitHub Guard Protected Branches",
  "tools.exec.ghGuard.allowedPrRepos": "Exec GitHub Guard Allowed PR Repos",
  "tools.exec.ghGuard.requireExplicitPrRepo": "Exec GitHub Guard Require Explicit PR Repo",
