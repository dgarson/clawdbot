...
export type AutomationsConfig = {
  ...
  enabled?: boolean;
  /** Custom store path for automation data (default: ~/.openclaw/automations/automations.json) */
  store?: string;
  /** Custom directory for artifact storage (default: ~/.openclaw/automations/artifacts) */
  artifactsDir?: string;
