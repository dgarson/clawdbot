...
export function isNodeCommandAllowed(params: {
  ...
  // Only enforce declared-commands check when node provides a non-empty list.
  // This maintains backward compatibility with older nodes that don't declare commands.
