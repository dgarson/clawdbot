...
export function taskProposal(params: {
  ...
  if (actionButtons.length > 0) {
    blocks.push(actions({ elements: actionButtons, blockId: `${params.actionIdPrefix}_actions` }));
  }
...
export function form(params: {
  ...
  blocks.push(
    actions({
      ...
      blockId: `${params.submitActionId}_action`,
    }),
  );
...
export function confirmation(params: {
  ...
  return [
    ...
    actions({
      ...
      blockId: `${params.actionIdPrefix}_actions`,
    }),
  ];
}
