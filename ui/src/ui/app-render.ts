...
import { renderTelemetryTab } from "./app-render-telemetry-tab.ts";
    ...
    <div class="shell ${isChat ? "shell--chat" : ""} ${chatFocus ? "shell--chat-focus" : ""} ${state.settings.navCollapsed ? "shell--nav-collapsed" : ""} ${state.onboarding ? "shell--onboarding" : ""}">
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        <section class="content-header">
          <div>
            ${state.tab === "usage" || state.tab === "telemetry" ? nothing : html`<div class="page-title">${titleForTab(state.tab)}</div>`}
            ${state.tab === "usage" || state.tab === "telemetry" ? nothing : html`<div class="page-sub">${subtitleForTab(state.tab)}</div>`}
          </div>
          <div class="page-meta">
