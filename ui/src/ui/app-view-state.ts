...
export type AppViewState = {
  ...
  agentsPanel: "dashboard" | "overview" | "files" | "tools" | "skills" | "channels" | "cron";
  ...
  sessionsSort: import("./views/sessions.js").SessionSortColumn;
  sessionsSortDir: import("./views/sessions.js").SessionSortDir;
  sessionsKindFilter: import("./views/sessions.js").SessionKindFilter;
  sessionsStatusFilter: import("./views/sessions.js").SessionStatusFilter;
  sessionsAgentLabelFilter: string;
  sessionsLaneFilter: import("./views/sessions.js").SessionLaneFilter;
  sessionsTagFilter: string[];
  sessionsViewMode: import("./views/sessions.js").SessionViewMode;
  sessionsShowHidden: boolean;
  sessionsAutoHideCompletedMinutes: number;
  sessionsAutoHideErroredMinutes: number;
  sessionsPreset: import("./views/sessions.js").SessionPreset;
  sessionsExpandedGroups: Set<string>;
  sessionsSelectedKeys: Set<string>;
  sessionsPreviewKey: string | null;
  sessionsPreviewLoading: boolean;
  sessionsPreviewError: string | null;
  sessionsPreviewData: import("./types.js").SessionsPreviewEntry | null;
  sessionsBusyKeys: Set<string>;
