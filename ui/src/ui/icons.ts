...
export const icons = {
  ...
  `,
  square: html`
    <svg viewBox="0 0 24 24"><rect width="18" height="18" x="3" y="3" rx="2" ry="2" /></svg>
  `,
  target: html`
    <svg viewBox="0 0 24 24">
      <circle cx="12" cy="12" r="10" />
  ...
  `,
  stop: html`
    <svg viewBox="0 0 24 24"><rect width="16" height="16" x="4" y="4" rx="2" /></svg>
  `,
  trash: html`
    <svg viewBox="0 0 24 24">
      <path d="M3 6h18" />
...
export function icon(
  name: IconName,
  _options?: { size?: number; class?: string; color?: string; strokeWidth?: number },
): TemplateResult {
  return icons[name];
}
