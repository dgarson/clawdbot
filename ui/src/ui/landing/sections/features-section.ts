...
const FEATURES: Feature[] = [
  {
    ...
    description:
      "Coordinate specialized agents under a single objective. Clawdbrain plans the work, delegates tasks, and keeps the run aligned.",
    size: "large",
    accent: "primary",
  },
  {
    ...
    description:
      "Define the outcome, constraints, and tools. Agents execute step-by-step with checkpoints and clear artifacts.",
    size: "medium",
  },
  {
    id: "memory",
    ...
    description:
      "Shared memory captures decisions, preferences, and context so every run starts smarter than the last.",
    size: "medium",
  },
  {
    id: "approvals",
    ...
    description:
      "Approval gates for sensitive actions—send, merge, deploy—so autonomy never becomes risk.",
    size: "small",
  },
  {
    id: "observability",
...
export class LandingFeatures extends LitElement {
  static styles = css`
    ...
    .feature-card.accent-primary {
      ...
      background: linear-gradient(135deg, rgba(99, 102, 241, 0.1) 0%, var(--landing-bg-surface) 50%);
    }
